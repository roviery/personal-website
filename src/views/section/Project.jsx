    ...
    <div className="container p-4 mx-auto my-40 lg:p-16">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
        <Box
          type='Website'
          title='KanbanApp'
          desc='Kanban Board website developed using golang and tailwindcss'
          icon={
            <xml version="1.0" className="absolute bottom-4 left-5 w-10 h-10">
          ...
          link='https://github.com/roviery/kanban-app'
        />
        <Box
          type='Android App'
          title='Catetin'
